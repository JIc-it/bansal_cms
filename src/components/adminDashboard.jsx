...
const AdminDetails = () => {
  ...
  <div style={{marginTop: 50, marginLeft: 18}}>
    <h4 className="heading">Admin / Name
      <a style={{marginLeft: 895}} className="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">Edit Details</a>
    </h4>
  </div>
