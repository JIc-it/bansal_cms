              ...
              <div className="card-body p-0">
                <div className="table-responsive active-projects style-1">
                  ...
                  <div className="row">
                    ...
                    <button className="btn btn-primary btn-sm" type="button" id="add-points-button"><i className="fa-regular fa-square-plus" /> Add New Architect</button>
                    </div>
                    <div className="col-2">
                  ...
                  <tr>
                    ...
                    <td>
                      <a className="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="/actdetails" role="button" aria-controls="offcanvasExample">View User</a>
                    </td>
                    <td>
                      <h6 align="center">...</h6>
                    </td>
