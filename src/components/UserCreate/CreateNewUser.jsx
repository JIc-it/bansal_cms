...
import { getAllLocations, getAllStates } from "../../axiosHandle/commonServicesHandle";
      ...
      <div style={offcanvasStyle}>
        ...
        <select
          ...
          onChange={(e) => {
            ...
            setSelectedRole(roleValue); // Update the selected role
            handleroledata({ role: roleValue }); // Pass the role value to the handleroledata function
          }}
        >
