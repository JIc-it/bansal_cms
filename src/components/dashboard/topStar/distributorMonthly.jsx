...
import { getDistributorMonthlyURLRequest } from '../../../axiosHandle/dashboardHandle';

export default function DistributorMonthly() {
    ...
    return (
        <div className="card-body p-0" style={{ height: 336 }}>
            <h4 className="heading mb-2" style={{ marginLeft: 15 }}>Top 10 Star Performers dm</h4>
