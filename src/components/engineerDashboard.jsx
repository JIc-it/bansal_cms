...
const EngineerDetails = () => {
  ...
  <div style={{marginTop: 50, marginLeft: 18}}>
    <h4 className="heading">Engineers / Name
      <a style={{marginLeft: 880}} className="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">Edit Details</a>
    </h4>
  </div>
          ...
          <div className="card-body p-0">
            <div className="table-responsive active-projects">
              ...
              <div className="row">
                ...
                <div className="col-3" style={{marginTop: 20, paddingLeft: 30}}>
                  <button className="btn btn-primary btn-sm" type="button" id="add-points-button">Add Points</button>
                </div>
              </div>
              <div>
