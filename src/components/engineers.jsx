              ...
              <div className="col-xl-4 col-sm-7 same-card">
                <div className="card">
                  <div className="card-body depostit-card">
                    <div className="depostit-card-media d-flex justify-content-between style-1">
                      <div>
                        <h6>New Engineers in current Qtr</h6><br />
                        <h3>12</h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="card-body p-0">
                <div className="table-responsive active-projects style-1">
                  ...
                  <div className="row">
                    ...
                    <button className="btn btn-primary btn-sm" type="button" id="add-points-button"><i className="fa-regular fa-square-plus" /> Add New Engineer</button>
                    </div>
                    <div className="col-2">
                  ...
                  <tr>
                    ...
                    <td>
                      <a className="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="/enggdetails" role="button" aria-controls="offcanvasExample">View User</a>
                    </td>
                    <td>
                      <h6 align="center">...</h6>
                    </td>
